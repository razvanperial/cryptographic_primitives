//! # Constants Module
//!
//! This module contains constant values used throughout various cryptographic
//! algorithms in the crate. These constants include lookup tables for AES mix columns
//! operations, substitution boxes (S-boxes), and permutation boxes (P-boxes) used in 
//! block cipher algorithms like AES and Feistel networks.
//! 
//! These precomputed tables optimize the encryption and decryption processes by 
//! reducing the computational overhead of real-time calculations during cryptographic 
//! transformations.

/// Galois Multiplication Lookup Tables for AES Mix Columns Operation (multiply by 2)
pub const MIX_COLUMNS_LOOKUP_2: [u8; 256] = [
...
/// Galois Multiplication Lookup Tables for AES Mix Columns Operation (multiply by 3)
pub const MIX_COLUMNS_LOOKUP_3: [u8; 256] = [
...
/// Galois Multiplication Lookup Tables for AES Mix Columns Operation (multiply by 9)
pub const MIX_COLUMNS_LOOKUP_9: [u8; 256] = [
...
/// Galois Multiplication Lookup Tables for AES Mix Columns Operation (multiply by 11)
pub const MIX_COLUMNS_LOOKUP_11: [u8; 256] = [
...
/// Galois Multiplication Lookup Tables for AES Mix Columns Operation (multiply by 13)
pub const MIX_COLUMNS_LOOKUP_13: [u8; 256] = [
...
/// Galois Multiplication Lookup Tables for AES Mix Columns Operation (multiply by 14)
pub const MIX_COLUMNS_LOOKUP_14: [u8; 256] = [

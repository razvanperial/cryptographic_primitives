//! # Constants Module
//!
//! This module contains various constant values used throughout the cryptographic primitives.
//! These constants include lookup tables for mix columns operations and substitution boxes
//! for the AES cipher.
